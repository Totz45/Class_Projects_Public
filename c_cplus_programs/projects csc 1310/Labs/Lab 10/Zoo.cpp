/*
	...
	Author: Tate Finley
	Date: 11/28/22
	Purpose: This program can insert, print, and remove creatures using a heap.
*/
...
int main()
{
	...
	ArrayMinHeap creatureHeap(100); //create a heap with 100 element capacity
	...
	do{
		...
		switch(choice)
		{
			...
			case 2: //print creatures
					printCreatures(creatureHeap);
					break;

			case 3: //remove next creature
					creatureHeap.remove();
					break;
...
void enterMagicalCreature(ArrayMinHeap &creatureHeap)
{
	...
	do{
		...
		cout << "inserting creature";
		//insert creature into heap
...
{
	//call display function to display creatures
